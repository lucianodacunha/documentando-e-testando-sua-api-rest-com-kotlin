...
import io.github.lucianodacunha.creditapp.entity.Address
...
class CustomerServiceTest {
  ...
  companion object {
    fun buildCustomer(
      firstName: String = "Luciano",
      lastName: String = "Kotlin",
      cpf: String = "28475934625",
      email: String = "luciano@email.com  ",
      password: String = "12345",
      zipCode: String = "12345",
      street: String = "Rua Um",
